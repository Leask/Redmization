jQuery("document").ready(function(){
    function show (){
        ...
        jQuery.post("http://testing.aysaas.com/projects/redmization/code-review-plugin/show.php", {url:url}, function(data,textStatus){
    ...
    jQuery(".line-num").bind ("click",function(){
        function insert(){
            ...
            if (content==""){
                ...
                jQuery.post("http://testing.aysaas.com/projects/redmization/code-review-plugin/sendmail.php",{
                    line:add,
                    primary:ab,
                    content:content,
                    username:username,
                    ...
                    url=jQuery("#content").children("h2").text();
                  url=url.substr(url.length-18);
                jQuery.post("http://testing.aysaas.com/projects/redmization/code-review-plugin/feedback.php",{
                    line:add,
                    primary:primary,
                    content:content,
                    username:username,
